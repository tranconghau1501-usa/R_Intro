...
1. Dùng `tidymodels` để tuning cả `cost_complexity`, `tree_depth`, và `min_n` đồng thời qua 5-Fold CV.
...
- **tidymodels:** <https://www.tidymodels.org/start/tuning/>
